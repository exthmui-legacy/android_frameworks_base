...
public class GamingModeHelper {
    ...
    public void startGamingMode(String packageName) {
        ...
        mContext.sendBroadcastAsUser(mGamingModeOn, UserHandle.CURRENT_OR_SELF);
    }

    public void stopGamingMode() {
        mCurrentGamePackage = "";
        mContext.sendBroadcastAsUser(mGamingModeOff, UserHandle.CURRENT_OR_SELF);
    }
