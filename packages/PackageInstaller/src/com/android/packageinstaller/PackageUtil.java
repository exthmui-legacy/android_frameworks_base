...
public class PackageUtil {
    ...
    static public class AppSnippet {
        ...
        public AppSnippet(@NonNull CharSequence label, @Nullable CharSequence versionName, @Nullable Drawable icon) {
            this.label = label;
    ...
    public static AppSnippet getAppSnippet(
        ...
        PackageParser.Package parsed = PackageUtil.getPackageInfo(pContext, sourceFile);
        //获取软件版本号
        packageInfo = PackageParser.generatePackageInfo(parsed, null,
                PackageManager.GET_PERMISSIONS, 0, 0, null,
                new PackageUserState());
        String versionName = packageInfo.versionName;
        return new PackageUtil.AppSnippet(label, versionName, icon);
    }
